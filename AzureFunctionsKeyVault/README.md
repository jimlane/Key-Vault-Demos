...
The application demonstrates utilizing the Azure App Configuration service to provide access to secrets stored in Azure Key Vault within an Azure Function. AzureAppConfiguration can be injected into an Azure Function by implementing a custom ConfigurationBuilder within an Azure Function class.
...
Once ConfigurationBuilder is implemented in the function's constructor, the local configuration object can be used as an array to reference configuration settings by name (sample provided).
